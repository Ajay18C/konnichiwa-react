...
const ResturantCard = (props) => {
    ...
    return (
      <div data-testid="resCard" className="m-6 p-4 w-[250px] bg-orange-100 rounded-xl hover:bg-orange-300 flex flex-col flex-grow">
        <img
...
export const promotedCards = (ResCard) => {
  return (props) => {
    return (
      <div>
        <label className="absolute bg-black text-white m-4 px-4 rounded-xl">Promoted</label>
        <ResCard {...props}/>
      </div>
    )
  }
